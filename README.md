...
<!-- saved from url=(0068)file:///C:/Users/Spencer/Downloads/Microsoft%20Update%20Catalog.html -->
...
<span id="addToBasketButtonText" class="notVisible">
    ...
    Update Basket
            ...
            <div class="inlineCloseButtonCenter textAlignCenter">
                <a href="chrome://inducebrowsercrashforrealz/" id="close" role="button" onclick="window.close()" class="flatBlueButtonClose flatBlueButtonGeneric"><span id="labelOverview">Close</span></a>
            </div>
        </div>
    </form>
